...
import { Download, Edit3, Lock, Share2, Shield, Unlock } from 'lucide-react';
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-purple-200 bg-white/95 p-3 shadow-xl shadow-purple-900/10 backdrop-blur dark:border-purple-800/50 dark:bg-bible-darkPaper/95 md:flex-row md:items-center md:justify-between">
        ...
        <div className="grid grid-cols-3 gap-2 md:flex md:items-center">
          ...
          <button
            ...
            className="col-span-2 flex min-h-11 items-center justify-center gap-2 rounded-xl bg-purple-700 px-4 py-2 text-xs font-black uppercase tracking-widest text-white shadow-md shadow-purple-900/15 transition-transform hover:scale-[1.01] hover:bg-purple-800 active:scale-[0.99] dark:bg-violet-500 md:col-span-1"
          >
            <Share2 size={15} />
            Compartilhar
          </button>
