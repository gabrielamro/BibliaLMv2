...
const SlideKonva = dynamic(() => import('./SlideKonva'), { 
  ssr: false,
  loading: () => <div className="w-full h-full bg-gray-900 animate-pulse flex items-center justify-center text-white/20 text-xs font-black uppercase tracking-widest">Iniciando Canvas...</div>
});
