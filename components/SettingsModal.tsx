...
import { Type, X, Maximize2, Sparkles, BookOpen } from 'lucide-react';
import { AppSettings } from '../types';
import { BIBLE_VERSIONS, DEFAULT_BIBLE_VERSION } from '../utils/bibleVersionPreferences';
  ...
  return (
    <div className="absolute top-16 right-4 z-50 w-72 bg-white dark:bg-gray-800 shadow-xl rounded-xl border border-gray-200 dark:border-gray-700 p-4 animate-in fade-in slide-in-from-top-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={onClose} className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300" aria-label="Fechar configurações">
          <X size={18} />
        </button>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="pb-4 border-b border-gray-100 dark:border-gray-700">
            ...
            {BIBLE_VERSIONS.map(v => (
              <button
                ...
                className={`flex flex-col items-center p-2 rounded-xl border-2 text-center transition-all ${
                  (settings.bibleVersion || DEFAULT_BIBLE_VERSION) === v.id
          ...
          {(settings.bibleVersion && settings.bibleVersion !== DEFAULT_BIBLE_VERSION) && (
        ...
        <div className="flex items-center justify-between pb-4 border-b border-gray-100 dark:border-gray-700">
          ...
          <button
            ...
            aria-label="Alternar leitura inteligente"
          >
