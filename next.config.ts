...
const nextConfig: NextConfig = {
    ...
    async redirects() {
        return [
            ...
            { source: '/culto', destination: '/meus-cultos', permanent: false },
            { source: '/minha-igreja', destination: '/meus-cultos', permanent: false },
            { source: '/minha-igreja/acompanhamento', destination: '/minhas-escalas#solicitacoes', permanent: false },
            { source: '/minha-igreja/designacoes', destination: '/minhas-escalas', permanent: false },
            { source: '/minha-igreja/equipes', destination: '/minhas-escalas#equipes', permanent: false },
