...
export const SYSTEM_VERSION = "2.10.9";
...
/**
 * Lista curada de 60 versículos para o "Versículo do Dia" na tela inicial.
 * Usada sem necessidade de IA — seleção aleatória a cada abertura do app.
 * As referências são compatíveis com bibleService.parseReference().
 */
export const DAILY_BIBLE_VERSES = [
  { text: "O SENHOR é o meu pastor, nada me faltará.", ref: "Salmos 23:1" },
  { text: "Posso todas as coisas naquele que me fortalece.", ref: "Filipenses 4:13" },
  ...
  { text: "Não andeis ansiosos por coisa alguma; antes em tudo fazei os vossos pedidos a Deus.", ref: "Filipenses 4:6" },
  { text: "E a paz de Deus, que excede todo o entendimento, guardará o vosso coração.", ref: "Filipenses 4:7" },
  ...
  { text: "Mas os que esperam no SENHOR renovam as suas forças. Voam alto como águias.", ref: "Isaías 40:31" },
  { text: "Tudo posso naquele que me fortalece.", ref: "Filipenses 4:13" },
  { text: "O SENHOR é o meu socorro e o meu escudo; nele o meu coração confia, e sou socorrido.", ref: "Salmos 28:7" },
  { text: "Buscai primeiro o reino de Deus e a sua justiça, e todas essas coisas vos serão acrescentadas.", ref: "Mateus 6:33" },
  { text: "Porque nada há impossível para Deus.", ref: "Lucas 1:37" },
  ...
  { text: "Posso fazer tudo por meio daquele que me fortalece.", ref: "Filipenses 4:13" },
  { text: "Deleita-te no SENHOR, e ele te concederá o que deseja o teu coração.", ref: "Salmos 37:4" },
  { text: "Mas eu, com a voz do louvor, te sacrificarei; pagarei o que promises. Do SENHOR vem a salvação.", ref: "Jonas 2:9" },
  { text: "Não temas, porque eu sou contigo; não te assombres, porque eu sou o teu Deus.", ref: "Isaías 41:10" },
  { text: "A misericórdia do SENHOR dura para sempre para os que o temem.", ref: "Salmos 103:17" },
  ...
  { text: "O SENHOR é compassivo e misericordioso, tardio para a ira e grande em amor.", ref: "Salmos 103:8" },
  { text: "Sede fortes e corajosos. Não temais e não vos aterrorizeis diante deles, porque o SENHOR, vosso Deus, é quem vai convosco.", ref: "Deuteronômio 31:6" },
  { text: "Do SENHOR é a terra e tudo o que nela há, o mundo e os que nele habitam.", ref: "Salmos 24:1" },
  ...
  { text: "O Senhor te abençoe e te guarde; o Senhor faça resplandecer o seu rosto sobre ti e te conceda graça.", ref: "Números 6:24" },
  { text: "Deus é o nosso refúgio e força, socorro bem presente na angústia.", ref: "Salmos 46:1" },
  { text: "O temor do SENHOR é o princípio da sabedoria, e o conhecimento do Santo é o entendimento.", ref: "Provérbios 9:10" },
  { text: "Mas eu sou o SENHOR, o teu Deus, que te tirei da terra do Egito.", ref: "Oseias 13:4" },
  { text: "Portanto, agora já não há nenhuma condenação para os que estão em Cristo Jesus.", ref: "Romanos 8:1" },
  { text: "E conhecereis a verdade, e a verdade vos libertará.", ref: "João 8:32" },
  { text: "Porque eu vivo, e vós vivereis também.", ref: "João 14:19" },
  { text: "Aguarda o SENHOR; tem bom ânimo, coragem em teu coração, e aguarda o SENHOR.", ref: "Salmos 27:14" },
  { text: "Mas a sabedoria que vem do alto é, primeiramente, pura; depois pacífica, moderada, tratável, cheia de misericórdia e de bons frutos.", ref: "Tiago 3:17" },
  ...
  { text: "O SENHOR te guardará de todo mal; ele guardará a tua alma.", ref: "Salmos 121:7" },
  { text: "Mas o fruto do Espírito é amor, alegria, paz, longanimidade, benignidade, bondade, fidelidade.", ref: "Gálatas 5:22" },
  { text: "Eu vim para que tenham vida, e a tenham em abundância.", ref: "João 10:10" },
  { text: "As misericórdias do SENHOR são a causa de não sermos consumidos, porque as suas misericórdias não têm fim.", ref: "Lamentações 3:22" },
  { text: "E tudo quanto pedirdes em meu nome, eu o farei, para que o Pai seja glorificado no Filho.", ref: "João 14:13" },
  { text: "O SENHOR é bom; é um forte baluarte no dia da angústia; e conhece os que nele confiam.", ref: "Naum 1:7" },
  { text: "Inclina a mim os teus ouvidos, livra-me depressa; sê-me uma forte rocha, uma casa de defesa para me salvar.", ref: "Salmos 31:2" },
  { text: "Tudo posso por meio daquele que me fortalece.", ref: "Filipenses 4:13" },
  { text: "Pois estou convencido de que nem a morte, nem a vida... nos pode separar do amor de Deus.", ref: "Romanos 8:38" },
  { text: "Porque somos feitura dele, criados em Cristo Jesus para as boas obras.", ref: "Efésios 2:10" },
  { text: "Guardai o meu mandamento: amai-vos uns aos outros como eu vos amei.", ref: "João 15:12" },
  { text: "Mas buscai primeiro o reino de Deus e a sua justiça, e todas essas coisas vos serão acrescentadas.", ref: "Mateus 6:33" },
  { text: "O SENHOR é misericordioso e clemente, tardio em iras e grande em beneficência.", ref: "Salmos 103:8" },
  { text: "Porque eu, o SENHOR, teu Deus, te seguro pela tua mão direita e te digo: Não temas, eu te ajudo.", ref: "Isaías 41:13" },
  { text: "E sabemos que tudo concorre para o bem daqueles que amam a Deus, daqueles que são chamados segundo o seu eterno propósito.", ref: "Romanos 8:28" },
...
export const DAILY_BREAD: Devotional = { date: "Hoje", title: "Pão da Vida", verseReference: "João 6:35", verseText: "Declarou-lhes Jesus: Eu sou o pão da vida; o que vem a mim jamais terá fome; e o que crê em mim jamais terá sede.", content: "João 6 registra estas palavras depois da multiplicação dos pães. A multidão procura Jesus por causa do alimento recebido, mas ele direciona a atenção para o alimento que permanece para a vida eterna (João 6:26–27). Esse contexto mostra que o sinal do pão aponta para algo maior do que a necessidade imediata.\n\nAo declarar ‘Eu sou o pão da vida’, Jesus não se apresenta apenas como alguém que oferece sustento: ele próprio é o centro do convite. No versículo, vir a ele e crer nele aparecem como respostas de confiança. A imagem da fome e da sede comunica a necessidade profunda do ser humano e a suficiência encontrada em Cristo.\n\nIsso não significa que o discípulo nunca enfrentará carências, dúvidas ou sofrimento. A promessa aponta para uma vida firmada em Jesus, não para a ausência de dificuldades. A aplicação pastoral é examinar quais coisas têm ocupado o lugar de fonte última de segurança e voltar a Cristo com fé sincera.", prayer: "Senhor Jesus, tu és o pão da vida. Ensina-me a buscar em ti o sustento que nenhuma conquista pode oferecer. Corrige meus desejos, fortalece minha fé e conduz minhas escolhas hoje. Amém." };
